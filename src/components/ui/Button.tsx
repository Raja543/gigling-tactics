...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        primary: "bg-primary text-white hover:bg-primary/90 shadow-[0_0_15px_rgba(226,59,214,0.35)] hover:shadow-[0_0_22px_rgba(226,59,214,0.55)]",
        ...
        gold: "bg-accent text-black hover:bg-accent/90 shadow-[0_0_15px_rgba(45,212,191,0.35)] hover:shadow-[0_0_22px_rgba(45,212,191,0.55)]",
      },
      size: {
        sm: "h-9 px-3 text-xs",
        md: "h-10 px-4 py-2",
